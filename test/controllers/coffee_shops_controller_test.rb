...
class CoffeeShopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coffee_shop" do
    assert_difference("CoffeeShop.count") do
      post coffee_shops_url, params: { coffee_shop: { address: @coffee_shop.address, name: @coffee_shop.name, phone: @coffee_shop.phone } }
    end
  ...
  test "should update coffee_shop" do
    patch coffee_shop_url(@coffee_shop), params: { coffee_shop: { address: @coffee_shop.address, name: @coffee_shop.name, phone: @coffee_shop.phone } }
